...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Логика лабиринта
    const maze = [
        ['path', 'path', 'path', 'question', 'wall', 'question', 'path', 'question'],
        ['wall', 'wall', 'wall', 'path', 'wall', 'path', 'wall', 'path'],
        ['path', 'wall', 'wall', 'path', 'wall', 'path', 'wall', 'path'],
        ['question', 'path', 'path', 'question', 'path', 'path', 'wall', 'path'],
        ['path', 'wall', 'wall', 'wall', 'wall', 'wall', 'wall', 'path'],
        ['path', 'wall', 'question', 'path', 'path', 'path', 'path', 'question'],
        ['path', 'wall', 'path', 'wall', 'wall', 'wall', 'wall', 'wall'],
        ['question', 'wall', 'question', 'path', 'path', 'question', 'path', 'path']
    ];
    ...
    const questions = [
        ...
        },
        {
            ...
            answers: ["Глагол", "Предлог", "Существительное"],
            correctAnswer: "Существительное"
        },
        {
        ...
        {
            question: "Найдите в предложении местоимение: 'Он приехал на велосипеде'",
            answers: ["он", "велосипеде", "на"],
            correctAnswer: "он"
        },
        {
            question: "Найдите в предложении наречие: 'Я прекрасно пела, а мама аплодировала'",
            answers: ["пела", "мама", "прекрасно"],
        ...
        {
            question: "Найдите в предложении частицу: 'Вон возле ствола осины папоротник вылез'",
            answers: ["вон", "возле", "вылез"],
            correctAnswer: "Междометие"
        },
        {
            question: "Найдите в предложении числительное: 'Кружок по бальным танцам начинается в одиннадцать часов утра'",
            answers: ["часов", "утра", "одиннадцать"],
            correctAnswer: "одиннадцать"
        },
        {
            question: "Какое из перечисленных слов является глаголом?",
            answers: ["Бегать", "Красивый", "Стол"],
            correctAnswer: "Бегать"
        },
        {
            question: "Какая часть речи связывает слова в предложении?",
            answers: ["Союз", "Числительное", "Местоимение"],
            correctAnswer: "Союз"
        },
        {
        ...
        {
            question: "Определите часть речи слова 'сказала' в предложении: 'Она сказала нам правду'.",
    ...
    const treasurePosition = { x: 7, y: 7 }; // Позиция сокровища
    ...
    const showModalQuestion = (cellElement) => {
        ...
        let shuffledOptions = shuffle([...question.answers]);
        ...
        shuffledOptions.forEach((answer, index) => {
            ...
            const answerNumber = index + 1; // Нумерация начинается с 1
            answerBlock.textContent = `${answerNumber}. ${answer}`;
            answerBlock.className = 'answer-block';

            // Сохраняем соответствие номера и ответа
            answerMapping[answerNumber] = answer;
        ...
        const handleKeyPress = (event) => {
            const pressedKey = parseInt(event.key); // Получаем нажатую клавишу
